...
export const OrderCancellationEmail = ({ order }: OrderCancellationEmailProps) => (
  <Html>
    <Head />
    <Body style={main}>
      ...
      <Container style={container}>
        ...
        <Section style={track.container}>
          <Row>
            ...
            <Column align="right">
              <Link
                href={`https://tire2-go.vercel.app/order-history/${order.id}`}
                style={global.button}
              >
                View Order
              </Link>
        ...
        <Section style={message}>
          ...
          <Text style={global.text}>
            Your order has been <b>successfully cancelled</b>.
          </Text>
          {order.reasonCancelled && (
            <Text style={{ ...global.text, color: "#747474", fontWeight: 600 }}>
              Cancellation Reason: {order.reasonCancelled}
            </Text>
          )}
          <Text style={global.text}>
...
export const OrderCancellationEmailHTML = (props: OrderCancellationEmailProps) =>
  render(<OrderCancellationEmail {...props} />, {
    pretty: true,
  });
