...
const navMain = [
  ...
  { title: "Tire Sizes", url: "/owner/tire-sizes" },
  ...
  { title: "Promotions & Discounts", url: "/owner/promotions-and-discounts" },
  ...
  { title: "Backup & Recovery", url: "/owner/backup-recovery" },
  { title: "User Management", url: "/owner/staff-management" },
  { title: "System Settings", url: "/owner/settings" },
];
