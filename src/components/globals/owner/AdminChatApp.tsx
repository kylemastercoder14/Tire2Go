        ...
        {isOpen && (
          <motion.div
            ...
            className={`fixed z-50 flex flex-col ${
              isFullscreen
                ? "inset-0 w-full h-full p-2 sm:p-4"
                : "bottom-16 sm:bottom-20 right-2 sm:right-4 w-[calc(100%-1rem)] sm:w-[95%] md:w-[900px] max-h-[calc(100vh-10rem)]"
            }`}
          >
            <Card className="flex flex-col w-full h-full min-h-0 border-2 shadow-xl">
              <CardHeader className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 border-b flex-shrink-0">
              ...
              <CardContent className="flex flex-col md:flex-row flex-1 min-h-0 overflow-hidden !p-0">
                {/* Sidebar */}
                <div className="w-full md:w-1/3 border-r border-b md:border-b-0 flex flex-col min-h-0">
                ...
                <div className="flex-1 flex flex-col min-h-0">
                  {activeConversation ? (
                    <>
                      ...
                      <CardFooter className="p-2 sm:p-4 sm:p-6 flex-shrink-0">
                        <form
